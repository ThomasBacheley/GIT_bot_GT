    ...
    async run(client, message, args) {
        try {
            ...
            getBddconnection().then((connection) => {
                ...
                connection.query('INSERT INTO heroes (`name`,`role`,`weapon`,`shield`,`accesory`,`cards`,`merch_item`,`pp_link`,`champion_link`) VALUES (?,?,?,?,?,?,?,?,?)',
                [hero.name,hero.role,hero.weapon,hero.shield,hero.accesory,hero.cards,hero.merch_item,hero.pp_link,hero.champion_link],
